...
################################################################################
## Form generated from reading UI file 'AltaIngreso-Producto.ui'
##
...
class Ui_newProducto(object):
    def setupUi(self, newProducto):
        ...
        self.lnEditProveedor = QLineEdit(newProducto)
        self.lnEditProveedor.setObjectName(u"lnEditProveedor")
        self.lnEditProveedor.setEnabled(False)
        self.lnEditProveedor.setMaximumSize(QSize(220, 22))

        self.formLayout_2.setWidget(3, QFormLayout.FieldRole, self.lnEditProveedor)
    ...
    def retranslateUi(self, newProducto):
        ...
        self.lblPrecio.setText(QCoreApplication.translate("newProducto", u"<html><head/><body><p>Precio unitario venta<span style=\" font-weight:700; color:#ff0000;\">*</span></p></body></html>", None))
        ...
        self.lblDistr.setText(QCoreApplication.translate("newProducto", u"<html><head/><body><p>Proveedor</p></body></html>", None))
        self.lnEditProveedor.setText(QCoreApplication.translate("newProducto", u"<Distribuidor seleccionado>", None))
    # retranslateUi
