...
"color:black;")
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"[Alerta] Datos Invalidos", None))
        self.img.setText("")
        self.label.setText(QCoreApplication.translate("Dialog", u"Los datos ingresados no son validos o estan fuera de rango.\n"
