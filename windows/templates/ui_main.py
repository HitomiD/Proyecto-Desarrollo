...
"color: black;")
        ...
        self.btnNuevoProducto = QPushButton(self.widget)
...
"")
        ...
        self.btnModProducto = QPushButton(self.widget)
...
"")
        ...
        self.btnElimProducto = QPushButton(self.widget)
...
"")
        ...
        self.nombreProveedor = QLineEdit(self.groupBoxProveedor_6)
        self.nombreProveedor.setObjectName(u"nombreProveedor")

        self.gridLayout_7.addWidget(self.nombreProveedor, 0, 1, 1, 1)

        self.telefonoProveedor = QLineEdit(self.groupBoxProveedor_6)
        ...
        self.cuilProveedor = QLineEdit(self.groupBoxProveedor_6)
