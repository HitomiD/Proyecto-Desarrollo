...
"color:black;")
        ...
        self.tablaIngresosDetalle.setHorizontalHeaderItem(0, __qtablewidgetitem160)
        __qtablewidgetitem161 = QTableWidgetItem()
        self.tablaIngresosDetalle.setHorizontalHeaderItem(1, __qtablewidgetitem161)
        ...
        self.tablaIngresosDetalle.setVerticalHeaderItem(1, __qtablewidgetitem165)
        __qtablewidgetitem166 = QTableWidgetItem()
        self.tablaIngresosDetalle.setVerticalHeaderItem(2, __qtablewidgetitem166)
        __qtablewidgetitem167 = QTableWidgetItem()
        self.tablaIngresosDetalle.setVerticalHeaderItem(3, __qtablewidgetitem167)
...
"color:black;")
        self.tablaIngresos.setSizeAdjustPolicy(QAbstractScrollArea.AdjustToContentsOnFirstShow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem138 = self.tablaIngresosDetalle.horizontalHeaderItem(1)
        ___qtablewidgetitem138.setText(QCoreApplication.translate("MainWindow", u"Precio de compra", None));
        ___qtablewidgetitem139 = self.tablaIngresosDetalle.horizontalHeaderItem(2)
        ___qtablewidgetitem139.setText(QCoreApplication.translate("MainWindow", u"Cantidad", None));
        ___qtablewidgetitem140 = self.tablaIngresosDetalle.horizontalHeaderItem(3)
